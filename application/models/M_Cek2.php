...
class M_Cek2 extends CI_Model
{
    ...
    {
        return $this->db->query("SELECT * FROM tb_santri WHERE jkl = 'Laki-laki' AND aktif = 'Y' AND k_formal = '$kelas' AND t_formal = '$formal' AND NOT EXISTS (SELECT nis FROM pulang WHERE pulang.nis = tb_santri.nis) ");
        // return $this->db->;
    }
}

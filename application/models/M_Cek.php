...
class M_Cek extends CI_Model
{
    ...
    {
        return $this->db->query("SELECT * FROM tb_santri WHERE (jkl = '$this->jkl1' OR jkl = '$this->jkl2') AND aktif = 'Y' AND k_formal = '$kelas' AND t_formal = '$formal' AND NOT EXISTS (SELECT nis FROM surat WHERE surat.nis = tb_santri.nis) ");
        // return $this->db->;
    }
}

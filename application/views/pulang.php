                  ...
                  <div class="card-body">
                    <div class="d-flex flex-row align-items-center">
                      ...
                      <div class="ms-3">
                        ...
                        <p class="mt-2 text-muted card-text">Sudah Pulang</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card-body">
                    <div class="d-flex flex-row align-items-center">
                      ...
                      <div class="ms-3">
                        ...
                        <p class="mt-2 text-muted card-text">Belum Pulang</p>
                      </div>
                    </div>
                  </div>
                </div>
              </div>
              <button class="btn btn-primary btn-sm btn-block" onclick="window.location='<?= base_url('pulang/pulangDetail') ?>'">Lihat list data</button>
            </div>

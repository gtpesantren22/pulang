      ...
      <div class="col-md-12 grid-margin">
        <div class="row">
          <div class="col-12 col-xl-8 mb-4 mb-xl-0">
            <h3 class="font-weight-bold">Absensi Kembali Santri</h3>
            <h6 class="font-weight-normal mb-0">Aplikasi Absensi Kembali Santri PP. Darul Lughah Wal Karomah </h6>
          </div>
                ...
                <div class="dropdown flex-md-grow-1 flex-xl-grow-0">
                  ...
                  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuDate2">
                    <?php foreach ($mts_kelas as $dt) : ?>
                      <a class="dropdown-item" href="<?= base_url('cek3/kelas/MTs/') . $dt->k_formal; ?>">Kelas <?= $dt->k_formal; ?></a>
                    <?php endforeach; ?>
                  </div>
                </div>
              </div>
                ...
                <div class="dropdown flex-md-grow-1 flex-xl-grow-0">
                  ...
                  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuDate2">
                    <?php foreach ($smp_kelas as $dt) : ?>
                      <a class="dropdown-item" href="<?= base_url('cek3/kelas/SMP/') . $dt->k_formal; ?>">Kelas <?= $dt->k_formal; ?></a>
                    <?php endforeach; ?>
                  </div>
                </div>
              </div>
                ...
                <div class="dropdown flex-md-grow-1 flex-xl-grow-0">
                  ...
                  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuDate2">
                    <?php foreach ($ma_kelas as $dt) : ?>
                      <a class="dropdown-item" href="<?= base_url('cek3/kelas/MA/') . $dt->k_formal; ?>">Kelas <?= $dt->k_formal; ?></a>
                    <?php endforeach; ?>
                  </div>
                </div>
              </div>
                ...
                <div class="dropdown flex-md-grow-1 flex-xl-grow-0">
                  ...
                  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuDate2">
                    <?php foreach ($smk_kelas as $dt) : ?>
                      <a class="dropdown-item" href="<?= base_url('cek3/kelas/SMK/') . $dt->k_formal; ?>">Kelas <?= $dt->k_formal; ?></a>
                    <?php endforeach; ?>
                  </div>
                </div>
              </div>
